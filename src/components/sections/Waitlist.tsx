  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your digital signature has been recorded for priority deployment.",
      });
      setEmail("");
    } catch (error) {
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tight leading-none mb-8 text-[#f0ead8]">
            ...
            <span
              style={{
                color: themeRed,
                textShadow: "0 0 30px rgba(178,34,34,0.4)",
              }}
            >
              Agnexi
            </span>
          ...
          <p className="text-[#f0ead8]/50 text-lg md:text-xl max-w-xl mx-auto mb-16 leading-relaxed font-light">
            Be the first to claim your portable financial credential. No
            middlemen. No borders. Total autonomy.
          </p>
