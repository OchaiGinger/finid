...
export function Hero() {
  ...
  return (
    <main
      ref={containerRef}
      className="relative bg-[#0a0101] text-[#f0ead8] overflow-hidden selection:bg-[#B22222] font-['Syne',sans-serif]"
    >
      {/* VIGNETTE & GRID */}
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(${themeRed} 1px, transparent 1px), linear-gradient(90deg, ${themeRed} 1px, transparent 1px)`,
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-[#0a0101] via-transparent to-[#0a0101]" />
      </div>
        ...
        <div className="col-span-full md:col-span-4 flex flex-col items-start">
          ...
          <div className="reveal-item mb-20 flex items-center gap-4">
            <span
              ...
              className="w-2 h-2 rounded-full shadow-[0_0_15px_rgba(178,34,34,0.6)]"
            />
            <p
              style={{ color: themeRed }}
              className="text-xs font-bold tracking-[0.6em] uppercase font-mono opacity-60"
            >
          ...
          <div className="reveal-item mt-10 mb-32 group inline-flex items-center cursor-pointer border-b border-white/5 pb-6 hover:border-[#B22222]/40 transition-all duration-1000">
            <span className="text-[10px] font-bold tracking-[0.8em] uppercase mr-12 font-mono">
              Join the waitlist
            </span>
            <ArrowRight
              style={{ color: themeRed }}
              className="w-5 h-5 group-hover:translate-x-10 transition-transform duration-1000 ease-in-out"
            />
          </div>
