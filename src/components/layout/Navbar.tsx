  ...
  return (
    <nav className={cn(
      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
          <div className="flex items-center gap-8 text-[11px] font-mono uppercase tracking-[0.2em] text-[#f0ead8]/40">
            <Link href="#product" className="hover:text-[#B22222] transition-colors">Product</Link>
            <Link href="#solutions" className="hover:text-[#B22222] transition-colors">Solutions</Link>
            <Link href="#api" className="hover:text-[#B22222] transition-colors">API</Link>
            <Link href="#docs" className="hover:text-[#B22222] transition-colors">Docs</Link>
          </div>

          <div className="h-4 w-[1px] bg-white/10 mx-2" />

          <div className="flex items-center gap-4">
            <Button variant="ghost" className="text-[#f0ead8]/60 hover:text-white hover:bg-white/5 font-mono text-[10px] uppercase tracking-widest">
              Log In
            </Button>
      ...
      <div className={cn(
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[300px] bg-[#B22222]/10 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="flex flex-col gap-8 w-full max-w-sm relative z-10">
          ...
          <div className="mt-8 flex flex-col gap-4">
            ...
            <Button variant="outline" className="w-full h-16 rounded-2xl border-white/10 bg-transparent text-[#f0ead8] text-lg font-black uppercase tracking-widest hover:bg-white/5">
              Login
            </Button>
          </div>
        </div>
