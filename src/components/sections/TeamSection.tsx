...
const TEAM = [
  {
    ...
    image: "https://broadwayplatform.com/wp-content/uploads/2026/03/Frame-15-574x661.webp",
    speed: "0.1"
  },
  {
    name: "Elena Vance",
    role: "Chief Product Officer",
    bio: "Expert in behavioral AI and user experience, ensuring FinID remains intuitive yet powerful.",
        ...
        <div className="mt-40 pt-20 border-t border-black/5 flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="max-w-md">
            <p className="text-2xl font-bold tracking-tight text-black">
              In partnership with <span className="text-[#B22222]">SPRIBE</span>, we are redefining the global standard for digital identity.
            </p>
          </div>
          <div className="bg-[#0a0101] p-8 md:p-12 rounded-[2.5rem] text-white md:max-w-md">
            <p className="text-white/60 text-sm font-mono leading-relaxed italic">
              "Our collective responsibility is to provide a secure, autonomous, and memorable digital experience for millions of daily users."
            </p>
            <div className="mt-6">
              <p className="text-sm font-black uppercase tracking-widest">Official Executive Statement</p>
            </div>
          </div>
        </div>
