      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-12 gap-12 mb-24">
          ...
          <div className="col-span-full md:col-span-4">
            ...
            <p className="text-[#f0ead8]/40 text-sm leading-relaxed max-w-[280px] font-light">
              The autonomous financial identity protocol. Decentralized, portable, and secure by design.
            </p>
          ...
          <div className="col-span-full md:col-span-2">
            ...
            <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-mono text-emerald-500 uppercase tracking-wider">Nodes Online</span>
              </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-[10px] font-mono text-white/10 tracking-widest uppercase">
            © {currentYear} BROADWAY PLATFORM · FINID PROTOCOL v2.4.0
          </div>
          
          <div className="flex items-center gap-8">
             <div className="flex items-center gap-2 text-[10px] font-mono text-white/20 uppercase tracking-widest">
                <Globe className="w-3 h-3" />
                <span>Standard Time: {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false })} UTC</span>
             </div>
             <div className="flex items-center gap-2 text-[10px] font-mono text-white/20 uppercase tracking-widest">
